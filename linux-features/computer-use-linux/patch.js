...
module.exports = [
  ...
  webviewAssetPatch({
    ...
    missingDescription: "local thread dynamic-tool request construction",
    skipDescription: "Linux Codex app thread-tools patch",
    apply: applyLinuxCodexAppThreadToolsPatch,
  }),
  webviewAssetPatch({
    id: "ui-availability",
    phase: "webview-asset",
